                   ...
                   <div class="col-md-8">
                       <form method="POST" enctype="multipart/form-data">
                        <div class="form-group <?php if(form_error('id_karyawan')) echo 'has-error'?>">
                          ...
                          <input readonly="" type="text" id="id_karyawan" name="id_karyawan" class="form-control id_karyawan " placeholder="ID Agen" value="<?php echo autoID('AGN', 'karyawan') ?>">
                          <?php echo form_error('id_karyawan', '<small style="color:red">','</small>') ?>
                           ...
                           <div class="form-group <?php if(form_error('nama_karyawan')) echo 'has-error'?>">
                               ...
                               <input type="text" id="nama_karyawan" name="nama_karyawan" class="form-control nama_karyawan" placeholder="Nama Agen" value="<?php echo set_value('nama_karyawan') ?>">

...
class barang_model extends CI_Model {
	...
	public function get_harga_barang_json()
	{
		...
		$this->datatables->select('id_barang, barcode,nama_barang, diskon, harga_pokok , nama_kategori,golongan_1, nama_supplier, satuan, diskon, stok_outlet.stok AS stok_q');
		$this->datatables->from('stok_outlet');
	...
	public function insert($post)
	{
		...
		$data = [
			...
			'qty_1' => htmlspecialchars($post['qty_1']),
			'qty_2' => htmlspecialchars($post['qty_2']),
			'qty_3' => htmlspecialchars($post['qty_3']),
			'qty_4' => htmlspecialchars($post['qty_4'])
		];

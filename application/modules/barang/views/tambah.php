        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input autocomplete="off" type="text" id="qty_1" name="qty_1" class="form-control qty_1 <?php if(form_error('qty_1')) echo 'is-invalid'?>" placeholder="Qty 1" value="1">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input autocomplete="off" type="text" id="qty_2" name="qty_2" class="form-control qty_2 <?php if(form_error('qty_2')) echo 'is-invalid'?>" placeholder="Qty 2" value="<?php echo set_value('qty_2') ?>">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input autocomplete="off" type="text" id="qty_3" name="qty_3" class="form-control qty_3 <?php if(form_error('qty_3')) echo 'is-invalid'?>" placeholder="Qty 3" value="<?php echo set_value('qty_3') ?>">
            <input type="hidden" name="q3" class="qty_3_hidden" value="">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input autocomplete="off" type="text" id="qty_4" name="qty_4" class="form-control qty_4 <?php if(form_error('qty_4')) echo 'is-invalid'?>" placeholder="Qty 4" value="<?php echo set_value('qty_4') ?>">

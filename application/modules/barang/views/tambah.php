        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input readonly autocomplete="off" type="text" id="qty_1" name="qty_1" class="form-control qty_1 <?php if(form_error('qty_1')) echo 'is-invalid'?>" placeholder="Qty 1" value="1">

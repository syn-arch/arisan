...
class barang extends MX_Controller {
	...
	public function export()
	{
		...
		->setCellValue('S1', 'Profit 1')
		->setCellValue('T1', 'Profit 2')
		->setCellValue('U1', 'Profit 3')
		->setCellValue('V1', 'Profit 4')
		;
		...
		foreach($barang as $row) {
			...
			->setCellValue('O' . $i, $row['qty_1'])
			->setCellValue('P' . $i, $row['qty_2'])
			->setCellValue('Q' . $i, $row['qty_3'])
			->setCellValue('R' . $i, $row['qty_4'])
			->setCellValue('S' . $i, $row['profit_1'])
			->setCellValue('T' . $i, $row['profit_2'])
			->setCellValue('U' . $i, $row['profit_3'])
			->setCellValue('V' . $i, $row['profit_4']);
			$i++;
		}                           
